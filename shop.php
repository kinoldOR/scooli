...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($check_cart_numbers) > 0){
      $message[] = 'از قبل در سبد خرید موجوده';
   }else{
...
<div dir="rtl" class="heading">
   <h3 class="kodf">فروشگاه ما</h3>
   <p class="fatext"> <a class="fatext" href="home.php">خانه</a> / فروشگاه </p>
</div>
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
      ...
      <?php
         ...
         echo '<p class="empty">هیچ محصولی اضافه نشده</p>';
      }
      ?>
   </div>
